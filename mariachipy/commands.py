...
class SchoolNotes():
    ...
    def on_callback_query(self, msg):
        ...
        cb_data_subjects_t = {}
        cb_data_subjects_m = {}
        for tag in self.notes['subjects']:
        ...
        # List homeworks
            ...
            keyboards = []
            for tag, content in self.notes['subjects'].items():
        ...
        # List homeworks for a given subject
            ...
            if data in cb_data_subjects_t:
                if msg_id != None:
                    t_reply = '*Tarefas de %s*\r\n' % self.notes['subjects'][cb_data_subjects_t[data]]['name']
                    t_reply += 'total: %d' % len(self.notes['subjects'][cb_data_subjects_t[data]]['tarefas'])
        ...
        # List homeworks for a given subject
            ...
            if data in cb_data_subjects_m:
                if msg_id != None:
                    name = self.notes['subjects'][cb_data_subjects_m[data]]['name']

                    content_len = len(self.notes['subjects'][cb_data_subjects_m[data]]['materia_provas'])
                    ...
                    if content_len > 0:
                        ...
                        for content in self.notes['subjects'][cb_data_subjects_m[data]]['materia_provas']:
                            m_reply += ' - %s\r\n' % content['text']
